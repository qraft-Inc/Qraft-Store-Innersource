  ...
  return (
    <nav className="app_navbar">
      ...
      <ul className="app_navbar-links">
        ...
        <li className="p_opensans">
          <Link to="/artist">Featured artists</Link>
        </li>
        <li className="p_opensans">
          <Link to="/freelancer">Become freelancer</Link>
        </li>
      </ul>
      <div className="app_navbar-right">
        <FiShoppingCart className="cart" />
        <a href="#login" className="p_opensans app_sign">
          <Link to="/sign-up">Sign Up </Link>
        </a>
        <a href="#login" className="p_opensans app_login">
        ...
        {toggleMenu && (
          <div className="app_navbar-smallscreen_overlay flex_center slide-bottom">
            ...
            <ul className="app_navbar-smallscreen_links">
              ...
              <li className="p_opensans">
                <a href="#freelancer">Become freelancer</a>
              </li>
            </ul>
          </div>
        )}
